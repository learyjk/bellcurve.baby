...
export async function updateSession(request: NextRequest) {
  ...
  if (
    ...
    !request.nextUrl.pathname.startsWith("/baby") &&
    !request.nextUrl.pathname.startsWith("/announcement")
  ) {
  ...
  // If user is authenticated and trying to access login or signup pages, redirect to /baby
  if (
    user &&
